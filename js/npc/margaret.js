    ...
    'simon-margaret': {
      'ritual-roasters': 
        new Travel(this, [
          ...
          { act: 'path', area: 'le-chateau-lobby', start: { x: 3, y: 3 }, end: { x: 3, y: 6 }, dur: ANIM_LENGTH_NPC },
    ...
    'library': {
      'simon-margaret': 
        new Travel(this, [
          ...
          { act: 'exit', to: 'le-chateau-lobby', x: 3, y: 6 },
          { act: 'path', area: 'le-chateau-lobby', start: { x: 3, y: 6 }, end: { x: 4, y: 3 }, dur: ANIM_LENGTH_NPC },
